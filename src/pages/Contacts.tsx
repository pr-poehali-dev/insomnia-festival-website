            ...
            <div className="space-y-8">
              ...
              <div className="p-6 rounded-xl bg-slate-800/30 border border-slate-700/50">
                ...
                <div className="space-y-3 text-slate-300">
                  <p className="text-lg">Калужская область</p>
                  <p>Фестивальная площадка в живописной природной зоне</p>
                  <p>Основная сцена - Центральная поляна</p>
                  <div className="pt-4">
                    <p className="text-emerald-400 font-medium mb-2">
                      Как добраться:
                    </p>
                    <ul className="space-y-1 text-sm">
                      <li>🚗 На автомобиле: 2 часа из Москвы</li>
                      <li>🚌 Организованные автобусы от м. Теплый Стан</li>
