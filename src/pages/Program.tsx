...
const Program = () => {
  const schedule = [
      ...
      events: [
        {
          time: "17:00",
          stage: "Cinema",
          artist: "Фестиваль короткометражек",
          type: "Кино",
          duration: "4 часа",
        },
        {
    ...
    {
      day: "Воскресенье, 21 июля",
      events: [
        {
          time: "16:00",
          stage: "Art Zone",
          artist: "Мастер-классы",
          type: "Воркшопы",
          duration: "3 часа",
        },
        {
        ...
        },
        {
          time: "21:00",
          stage: "Cinema",
          artist: "Закрытие: документальный фильм",
          type: "Кино",
          duration: "2 часа",
        },
        {
